...
$result=$empcontroller->getEmpInfo($id);
$deptcontroller=new DeptController();
$deptresults=$deptcontroller->getDeptsInfo();
if(isset($_POST['submit']))
{
    ...
    if($errors==false)
    {
        ...
        $result=$empcontroller->updateEmpInfo($id,$name,$nrc,$position,$department,$email,$phone,$address);
        if($result)
        {
                        ...
                        <div class="col-md-12">
                            <form method="post">
                                <div class="m-2">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="Enter emp name" value="<?php echo $result[0]['name'];?>">
                                    <span class="text-danger"><?php if(isset($name_error)) echo $name_error; ?></span>
                                </div>
                                <div class="m-2">
                                    <label class="form-label">NRC</label>
                                    <input type="text" name="nrc" class="form-control" placeholder="Enter NRC No." value="<?php echo $result[0]['nrc']; ?>">
                                    <span class="text-danger"><?php if(isset($nrc_error)) echo $nrc_error; ?></span>
                                </div>
                                <div class="m-2">
                                    <label class="form-label">Position</label>
                                    <input type="text" name="position" class="form-control" placeholder="Enter Position" value="<?php echo $result[0]['position']; ?>">
                                ...
                                <div class="m-2">
                                    ...
                                    <input type="text" name="email" class="form-control" placeholder="Enter email" value="<?php echo $result[0]['email']; ?>">
                                    <span class="text-danger"><?php if(isset($email_error)) echo $email_error; ?></span>
                                </div>
                                <div class="m-2">
                                    <label class="form-label">Phone</label>
                                    <input type="text" name="phone" class="form-control" placeholder="Enter Phone" value="<?php echo $result[0]['phone']; ?>">
                                    <span class="text-danger"><?php if(isset($phone_error)) echo $phone_error; ?></span>
                                </div>
                                <div class="m-2">
                                    <label class="form-label">Address</label>
                                    <input type="text" name="address" class="form-control" placeholder="Enter Address" value="<?php echo $result[0]['address'] ?>">
